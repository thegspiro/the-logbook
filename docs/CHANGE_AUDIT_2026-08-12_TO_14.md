...
The immediate capture queue is: saved-ballot settings in the template picker;
manual-paper ballot count; station-board dashboard; admin-hours summary and
category editor; store dashboard counts/order filters/open-banner toggle; Room
...
filters, member payment method, banner), **14/16** (session linkage, scoring,
