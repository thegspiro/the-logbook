...
Routine maintenance pass per the currency job's standing brief. Rebased onto
`origin/main` (1 commit, `dbf489af6` → `adb77807c`): PR #2569 recording the
merge of PR #2568 (Feature 14, Equipment check & shifts, security-review pass
5) — docs-only, touching `docs/security-review/PROGRESS.md` — no frontend/UI
change. Clean replay, no conflicts.
...
The 50-shots-missing-`expect` gap flagged in the prior pass (above) remains
open, awaiting its own dedicated pass; nothing in this range touches it
further.
...
branch. Rebased onto `origin/main` (4 commits, `ff9f6fdd1` → `93a5b5ce3`):
PR #2549 recording the merge of PR #2546 (Feature 06, Elections & ballots,
security-review pass 5) — docs-only, touching
`docs/security-review/ELEC-06-elections-ballots.md` and
`docs/security-review/PROGRESS.md` — no frontend/UI change. Clean replay, no
conflicts.
