...
| Printing with "Background graphics" on _(2026-08-15)_       | Browsers do not print page backgrounds by default. If you have switched that option on, check one page before running a batch — the app's themed background may print behind the sheet. See [Known Limitations](../KNOWN_LIMITATIONS.md) |
