...
| 18 | [Department Store](./18-storefront.md) | Store settings, catalog & variants, personalization, product photos, order windows, member ordering, payment buttons (Venmo/PayPal/Cash App/Zelle), recording payment, PayPal reconciliation, vendor tallies |
