...
**203 pull requests (#2078 – #2297).** Thirty-four schema migrations, head
...
**118 changelog sections** carry a date inside this window. That is the number
...
| **Security review rotation — pass 3**                    | #2085–#2182 and the pass-3 series                        | Every module                                                                                                                                                                                                                                                                      | `docs/security-review/*.md`, `PROGRESS.md`                                                                                                                                                                                                                                                                                           | The rotation completed its third pass over the core features in this window. Findings and disposition are per-feature in [`docs/security-review/`](./security-review/); the user-visible half is in `CHANGELOG.md` under the 2026-08-31 → 2026-09-06 dates                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
