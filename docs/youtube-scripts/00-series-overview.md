...
| 13 | Multi-Class Courses & Cohorts — Scheduling a Whole Class Series | Training officers running recruit schools / academies | 10–14 min |
...
> Script 13 is the scheduling counterpart to Script 11: 11 defines what a recruit
> must *accomplish* (the pipeline), 13 defines *when the classes meet* (the course
...
| 8o | Schedule a Whole Recruit School in One Shot | Script 13 |
| 8p | Reordering Classes Doesn't Reschedule Them | Script 13 |
| 8q | Cohort or Recurring Session — Which Do I Want? | Script 13 |
