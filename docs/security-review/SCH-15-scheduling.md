...
| `pytest tests/ -q -k "scheduling or shift or swap or calcom"` | ✅ 805 passed, 1 skipped (pre-existing optional-dep skip) — +2 (SCH-12 guard tests)                                                                                     |
| `pytest tests/` (full backend suite)                          | ✅ 10487 passed, 21 skipped (pre-existing Docker/no-MySQL/optional-dep) — +2                                                                                            |
| `tsc --noEmit`                                                | ✅ 0 errors                                                                                                                                                             |
| `eslint .`                                                    | ✅ 0 errors                                                                                                                                                             |
