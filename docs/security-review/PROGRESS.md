...
| Field       | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PR          | (opening — number added in a follow-up commit once GitHub assigns it)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |
| Branch      | `claude/security-review-facilities`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| Feature     | 12 Facilities                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
| CI          | fresh push, awaiting first run                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| Threads     | none yet                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| Last tended | 2026-08-26 — no code changes. Re-verified FAC-1 through FAC-5 (including the HIGH-severity FAC-5 sensitive-family permission gate and the FAC-3/FAC2-1 10-site XC-1 FK-validation sweep) all still hold; confirmed 98/98 routes permission-gated (up from 95, all growth pre-accounted-for or reviewed). Read the one genuinely new surface, `GET /{facility_id}/folders` (a bridge to the generic Documents module added since the last pass), in full: org-scoped throughout, no client-supplied folder ids, and verified it does not cross the `documents.view`/`facilities.view` permission boundary — it exposes folder names and document counts only, not content. FAC-4 (search wired but unexposed) remains open as a deliberate non-security owner-decision item, unchanged. Full completion gate green. See `docs/security-review/FAC-12-facilities.md` for the complete write-up. |
...
- **12 Facilities — no new findings, no code changes.** The most heavily
  audited module inherited by this rotation so far (module audit + 4
  app-review passes + a full product-delivery pass, all prior findings
  fixed except the deliberately-flagged FAC-4). Re-verified FAC-1 through
  FAC-5 all hold, including the HIGH-severity FAC-5 sensitive-family gate
  and the 10-site FAC-3/FAC2-1 XC-1 FK-validation sweep. Confirmed 98/98
  routes permission-gated (grown from 95). Read the one new surface in
  full — `GET /{facility_id}/folders`, a first-time bridge to the generic
  Documents module — and verified it's org-scoped, has no client-supplied
  folder ids, and doesn't cross the `documents.view`/`facilities.view`
  permission boundary (folder metadata + counts only, not document
  content). See `FAC-12-facilities.md`. Next: 13 apparatus & NFC.
