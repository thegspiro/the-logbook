...
| Field       | Value                                                                                                                                                                                                                                                                                                                                                                                                                |
| ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| PR          | [#1846](https://github.com/thegspiro/the-logbook/pull/1846)                                                                                                                                                                                                                                                                                                                                                          |
| Branch      | `claude/security-review-scheduling`                                                                                                                                                                                                                                                                                                                                                                                  |
| Feature     | 15 Scheduling                                                                                                                                                                                                                                                                                                                                                                                                        |
| CI          | pending — just opened                                                                                                                                                                                                                                                                                                                                                                                                |
| Threads     | none yet                                                                                                                                                                                                                                                                                                                                                                                                             |
| Last tended | 2026-08-26 — opened. Re-verified SCH-1..8 (module-audit + 4 app-review passes) still hold after scheduling.py/scheduling_service.py roughly doubled in size since the last full read; 1 new finding (SCH-9, LOW, XC-1: responding_members user ids on shift calls not org-validated), fixed. Full write-up in `docs/security-review/SCH-15-scheduling.md`. Full completion gate green, full 8544-test backend suite. |
