...
| **Documents: summary ignores folder ACL**                                                                     | Partially resolved (LOW/design)                                                                                               | **DOC-5 fixed 2026-09-02:** folder authorization now walks every ancestor and fails closed on corrupt hierarchy. **DOC-4 still flagged:** `get_summary` aggregates across the whole organization past folder ACLs (counts only, no names/content); changing that stats contract remains a product decision. (DOC-4/5)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
