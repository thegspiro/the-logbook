...
| **Medical supplies: summary's low-stock count is capped at 10,000 active items**                                                     | Open (LOW, extreme-scale edge case — mitigated, not fully fixed)          | `medical_supply_summary`'s `low_stock` tile walks up to 10,000 active medical items (raised from a 500-row display-page cap that silently undercounted past the 500th, MSUP-3) — a department with more than 10,000 active medical items would still see an undercount past that point. Full closure needs a database-side aggregate rather than a raised page size, matching GF-33's disposition on the same shape of gap. Found by Codex review, security-review PR #2075 (MSUP-23 pass 2); see `docs/security-review/MSUP-23-medical-supplies.md` MSUP-3. (MSUP-3)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
