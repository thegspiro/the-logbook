...
| `20260604_0200` | `20260604_0100` | `20260604_0200_backfill_inventory_item_barcodes.py` | Backfill `INV-XXXXXXXX` barcodes for legacy `inventory_items` (barcodes now assigned at creation) |

> **Heads after 2026-06-09 (two — a merge is required before the next release):** `20260604_0001` (from PR #1063) and `20260604_0200` (from PR #1062) both descend from `20260528_0002`, so `alembic upgrade head` is currently ambiguous. A follow-up merge revision must reconcile these two heads. The fulfillment/backfill run (`20260604_0100` → `20260604_0200`) branched off `20260528_0002` **before** the `20260604_0001` head-merge landed, which is why the fork reopened.
