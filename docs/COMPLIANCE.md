...
| **ISO/IEC 27701 / privacy laws**           | PII/PHI data-subject rights                  | Closed 2026-07-31: data export, anonymization, consent tracking, and the public privacy/ToS pages all shipped (see gaps table). Remaining work is the deploying department's — its own retention schedule, notices, and processor agreements |
...
| Gap                                                              | Status                                                                                                                                                                                                                                                                                                                                                                                              |
| ---------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Privacy policy / ToS pages                                       | ✅ 2026-07-31, expanded 2026-08-17 — /privacy and /terms with org-configurable text (`GET /api/public/v1/legal`). Defaults state department control of the application and status-based access, and cover sources of data, public-records disclosure, monitoring, breach notification, minors, no-sale/no-ads/no-automated-decisions, data location, and a dated revision line                      |
