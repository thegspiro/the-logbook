...
| 19  | scheduling          | endpoints/scheduling.py, shift__.py, services/scheduling_service.py, shift___service.py                                                              | modules/scheduling                                   | ✅     |
...
| 22  | compliance/skills   | endpoints/compliance__.py, skills_testing.py, services/compliance___service.py, skills_testing_service.py                                            | (in-app)                                             | ✅     |
