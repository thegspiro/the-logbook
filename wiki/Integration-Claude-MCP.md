...
| Meetings   | `list_meetings`, `get_meeting_agenda`, `list_open_action_items`, `list_minutes`, `get_minutes`, `get_minutes_text` — **approved, non-executive minutes only**; long text (the agenda, reports and business, a dynamic section, or a motion's wording and discussion notes by motion id; a meeting's agenda) is read in 20,000-character pieces |
