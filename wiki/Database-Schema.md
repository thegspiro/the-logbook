...
| `notification_logs`        | In-app and email notification records with `action_url`, expiry, and `metadata` JSON column for structured context (shift_id, shift_date, checklist_count, etc.) _(updated 2026-03-26)_                                                                                                                                                                         |
