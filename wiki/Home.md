...
> **Release handoff:** [Changes from September 15 – 23, 2026](Recent-Changes-2026-09-15-to-09-23) — **suggestion boxes** for every member (named or anonymous, with per-box reviewers; the new `suggestions.manage` configures boxes but reads nothing), a membership pipeline whose **meeting stages advance when the event is finalized** and now bind a coordinator's own Advance, **inventory label tracking** with print-by-filter, forms that stop requiring or storing hidden questions, and the **department's logo as the installed app's icon**. Four migrations, head `5a70c5dcd138`; nothing moved address. Earlier windows: [September 12–15](Recent-Changes-2026-09-12-to-09-15), [September 6–12](Recent-Changes-2026-09-06-to-09-12), and [August 31 – September 6](Recent-Changes-2026-08-31-to-09-06) — **equipment checklists moved out of Shift Scheduling into Inventory** and **scheduling administration moved into the Administration section**, retiring **fourteen addresses** between them (thirteen with no redirect). Departments can now **name their own call types**; **Gmail and Microsoft 365 email, which had never been able to send, now send**; and there is a new opt-in **Claude (MCP) integration**, off by default. Thirty-four migrations, head `d7c1b95e2a40`, eleven of which do not reverse — none destructively — and **six upgrade steps revoke permissions from seeded positions**, one of them unconditionally, so read the upgrade notes before running it. Earlier windows: [August 24–31](Recent-Changes-2026-08-24-to-31) — a department organizational chart, membership class and status as two separate facts, the equipment check template builder rebuilt as one list, and the Testing Checklist turned into a module that ships switched off. [August 23–24](Recent-Changes-2026-08-23-to-24) — a scheduling board that claims a seat in one tap plus standing (recurring) shifts, NFC ID cards and an unattended check-in station, network label printers, one shared frame across four administration pages, and **five authorization gaps closed — four reachable by an ordinary member**. Twelve migrations, head `e7a41b6d09c2`, one of which does not reverse. Earlier windows: [August 19–23](Recent-Changes-2026-08-19-to-23) (departments publish their own privacy notice and terms; one equipment check per shift enforced by the database; phone dialogs finally tappable to the bottom), [August 17–19](Recent-Changes-2026-08-17-to-19), the [August 10–16 rollup](Recent-Changes-2026-08-10-to-16), and per-window detail for [August 15–16](Recent-Changes-2026-08-15-to-16) and [August 12–14](Recent-Changes-2026-08-12-to-14). All of them
...
- **[Inventory](Module-Inventory)** - Gear, uniforms and EMS supplies: tracking, assignments, pool items, thermal labels
