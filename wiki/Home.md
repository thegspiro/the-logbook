...
> **Release handoff:** [Changes from August 24–31, 2026](Recent-Changes-2026-08-24-to-31) — a department **organizational chart** any member can open, membership records that state **class and status as two separate facts**, the **equipment check template builder rebuilt as one list**, and the **Testing Checklist turned into a module that ships switched off**. Forty-five migrations, head `f6a7b8c9d0e1`, five of which do not reverse — and one of those **destroys org-chart holder data** on the way down — and **four upgrade steps revoke permissions from seeded positions**, so read the upgrade notes before running it. Earlier windows: [August 23–24](Recent-Changes-2026-08-23-to-24) — a scheduling board that claims a seat in one tap plus standing (recurring) shifts, NFC ID cards and an unattended check-in station, network label printers, one shared frame across four administration pages, and **five authorization gaps closed — four reachable by an ordinary member**. Twelve migrations, head `e7a41b6d09c2`, one of which does not reverse. Earlier windows: [August 19–23](Recent-Changes-2026-08-19-to-23) (departments publish their own privacy notice and terms; one equipment check per shift enforced by the database; phone dialogs finally tappable to the bottom), [August 17–19](Recent-Changes-2026-08-17-to-19), the [August 10–16 rollup](Recent-Changes-2026-08-10-to-16), and per-window detail for [August 15–16](Recent-Changes-2026-08-15-to-16) and [August 12–14](Recent-Changes-2026-08-12-to-14). All of them
