...
export const INVENTORY_HUB_CARDS: InventoryHubCard[] = [
  ...
  {
    // Not NFC-gated: assignments, checkouts and issuances count as seeing an
    // item, so the report is useful with no tags at all.
    id: 'not-seen',
    label: 'Items Not Seen',
    description: 'Items nobody has tapped or handed out in months',
  ...
  },
  {
    id: 'nfc-shelf-audit',
    label: 'Shelf Audit',
    description: 'Tap everything on a shelf to find what is missing or misplaced',
  ...
  },
  {
    ...
    description: 'Link NFC tags to untagged items one after another',
