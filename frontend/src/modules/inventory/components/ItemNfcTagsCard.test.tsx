...
import { ItemNfcTagsCard } from './ItemNfcTagsCard';

const { getItemNfcTags, linkItemNfcTag, updateNfcTag, unlinkNfcTag, scanner, writer } = vi.hoisted(() => ({
...
vi.mock('../../../services/api', () => ({
  inventoryService: { getItemNfcTags, linkItemNfcTag, updateNfcTag, unlinkNfcTag },
}));
...
const renderCard = () => renderWithRouter(<ItemNfcTagsCard itemId="item-1" itemName="Helmet 12" />);

describe('ItemNfcTagsCard', () => {
  beforeEach(() => {
    vi.clearAllMocks();
