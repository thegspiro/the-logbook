    ...
    <div className="max-w-2xl mx-auto p-6 min-h-screen bg-theme-surface-secondary">
      <div className="bg-theme-surface rounded-lg shadow-md p-8">
        ...
        <button
          ...
          disabled={processing}
          className="w-full px-8 py-4 bg-green-600 text-white text-lg font-semibold rounded-lg hover:bg-green-700 transition focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:bg-gray-400 disabled:cursor-not-allowed"
        >
