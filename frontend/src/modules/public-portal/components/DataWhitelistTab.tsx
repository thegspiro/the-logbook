...
export const DataWhitelistTab: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h3 className="text-lg font-semibold text-gray-900">Data Exposure Control</h3>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-4">
          <div className="flex items-center justify-between">
            ...
            <div className={`p-3 rounded-lg ${sensitiveEnabled > 0 ? 'bg-yellow-100' : 'bg-gray-100'}`}>
              <svg className={`w-6 h-6 ${sensitiveEnabled > 0 ? 'text-yellow-600' : 'text-gray-600'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
