        ...
        <div className="space-y-3">
          ...
          <div className="flex space-x-2">
            <input
              ...
              className="flex-1 px-4 py-2 border border-theme-surface-border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
            />
            <button
      ...
      <div className="bg-theme-surface rounded-lg shadow p-6">
        ...
        <div>
          ...
          <input
            ...
            min={1}
            max={100000}
            className="w-full px-4 py-2 border border-theme-surface-border rounded-lg focus:ring-2 focus:ring-red-500 focus:border-transparent"
          />
