...
const RevokeConfirmModal: React.FC<RevokeConfirmModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl max-w-md w-full p-6">
        <h3 className="text-lg font-semibold text-gray-900 mb-4">Revoke API Key?</h3>
...
export const APIKeysTab: React.FC = () => {
  ...
  const getStatusBadge = (key: any) => {
    ...
    if (key.is_expired) {
      return <span className="px-2 py-1 text-xs font-semibold rounded bg-orange-100 text-orange-800">Expired</span>;
    }
