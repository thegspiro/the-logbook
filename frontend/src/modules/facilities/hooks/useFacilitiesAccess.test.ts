  ...
  it.each([
    {
      ...
      expected: { canManage: false, canCreate: false, canEdit: false, canMaintenance: false },
    },
    {
      label: 'create only',
      permissions: ['facilities.view', 'facilities.create'],
      expected: { canManage: false, canCreate: true, canEdit: false, canMaintenance: false },
    },
    {
      label: 'edit',
      permissions: ['facilities.view', 'facilities.edit'],
      expected: { canManage: false, canCreate: true, canEdit: true, canMaintenance: true },
    },
    {
      label: 'maintenance',
      permissions: ['facilities.view', 'facilities.maintenance'],
      expected: { canManage: false, canCreate: false, canEdit: false, canMaintenance: true },
    },
    {
      label: 'manage',
      permissions: ['facilities.manage'],
      expected: { canManage: true, canCreate: true, canEdit: true, canMaintenance: true },
    },
