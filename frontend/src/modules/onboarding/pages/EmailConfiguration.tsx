              ...
              <>
                ...
                <div className="mt-4 bg-slate-800 rounded-lg p-4 text-sm text-theme-text-secondary">
                  ...
                  <a
                    ...
                    className="text-blue-700 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 underline mt-2 inline-block"
                  >
          ...
          <>
            ...
            <div className="mt-4 bg-slate-800 rounded-lg p-4 text-sm text-theme-text-secondary">
              ...
              <ul className="space-y-1">
                ...
                <li>• <span className="text-blue-700 dark:text-blue-400">465</span> - SSL</li>
                <li>• <span className="text-yellow-700 dark:text-yellow-400">25</span> - Unencrypted (not recommended)</li>
              </ul>
            </div>
          </>
        );
        ...
        <div className="max-w-3xl w-full">
          ...
          <div className="mt-8 flex gap-4">
            ...
            <button
              ...
              disabled={isSaving}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-red-600 to-orange-600 hover:from-red-700 hover:to-orange-700 text-theme-text-primary rounded-lg font-semibold transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
            >
          ...
          {/* Progress Indicator */}
          <ProgressIndicator currentStep={4} totalSteps={10} className="mt-6 pt-6 border-t border-theme-surface-border" />
