  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        label: 'Scheduling settings — General',
        permission: 'scheduling.manage',
        module: 'scheduling',
      },
      {
        path: '/scheduling/admin/settings/apparatus',
        label: 'Scheduling settings — Apparatus',
        permission: 'scheduling.manage',
        module: 'scheduling',
      },
      {
        path: '/scheduling/admin/settings/platoons',
        label: 'Scheduling settings — Platoons',
        permission: 'scheduling.manage',
        module: 'scheduling',
      },
      {
        path: '/scheduling/admin/settings/eligibility',
        label: 'Scheduling settings — Eligibility',
        permission: 'scheduling.manage',
        module: 'scheduling',
      },
      {
        path: '/scheduling/admin/settings/notifications',
        label: 'Scheduling settings — Notifications',
        permission: 'scheduling.manage',
        module: 'scheduling',
      },
      {
        path: '/scheduling/admin/settings/shift-reports',
        label: 'Scheduling settings — Shift reports',
        permission: 'scheduling.manage',
        module: 'scheduling',
      },
    ],
