      ...
      footer={
        <>
          <button
            type="button"
            onClick={onClose}
            className="btn-secondary text-theme-text-secondary inline-flex w-full justify-center text-base font-medium shadow-xs focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
          >
            Done
          </button>
        </>
