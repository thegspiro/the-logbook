...
const { lookupByCode, distributeItems, transferItem } = vi.hoisted(() => ({
  lookupByCode: vi.fn(), distributeItems: vi.fn(), transferItem: vi.fn(),
}));
