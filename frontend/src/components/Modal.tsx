          ...
          <div className="bg-theme-surface-modal px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
            <div className="flex items-start justify-between mb-4">
              ...
              <button
                type="button"
                onClick={onClose}
                className="rounded-md bg-theme-surface text-theme-text-muted hover:text-theme-text-primary focus:outline-none focus:ring-2 focus:ring-theme-focus-ring focus:ring-offset-2 focus:ring-offset-[var(--ring-offset-bg)] p-1 min-w-[44px] min-h-[44px] flex items-center justify-center"
