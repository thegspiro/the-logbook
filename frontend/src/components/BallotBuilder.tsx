    ...
    <div className="bg-white shadow rounded-lg p-6">
      ...
      {showTemplates && !selectedTemplate && (
        <div className="mb-6 p-4 bg-indigo-50 rounded-lg border border-indigo-200">
          <h4 className="text-sm font-semibold text-indigo-800 mb-3">Select a Template</h4>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {templates.map((template) => (
              <button
                ...
                className="text-left p-3 bg-white rounded-lg border border-indigo-200 hover:border-indigo-400 hover:shadow-sm transition-all"
              >
      ...
      {showCustomForm && (
        <div className="mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
          <h4 className="text-sm font-semibold text-gray-700 mb-3">Add Custom Ballot Item</h4>
          <div className="space-y-3">
            <div>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div>
                <label className="block text-sm font-medium text-gray-700">Vote Type</label>
                <select
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="require_attendance" className="text-sm text-gray-700">
            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  ...
                  {item.description && (
                    <p className="mt-1 ml-8 text-sm text-gray-500">{item.description}</p>
                  )}
