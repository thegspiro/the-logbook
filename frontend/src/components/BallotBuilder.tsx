        ...
        {!isClosed && (
          <div className="flex gap-2 relative" ref={templateRef}>
            ...
            <div className="relative">
              ...
              {showTemplatePopover && (
                <div className="absolute right-0 bottom-full mb-2 z-30 w-[28rem] max-w-[calc(100vw-2rem)] max-h-[70vh] overflow-y-auto bg-theme-surface-modal rounded-lg border border-theme-surface-border p-4 shadow-lg">
                  {!selectedTemplate ? (
                    <>
