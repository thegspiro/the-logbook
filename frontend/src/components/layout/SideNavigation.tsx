...
export const SideNavigation: React.FC<SideNavigationProps> = ({ departmentName, logoPreview, onLogout }) => {
  ...
  // Determine if user has any admin permission (to show/hide Administration
  // section). The shared helper's list mirrors the section items' gates —
  // extend it there, never inline, so Side/Top navigation cannot drift apart.
