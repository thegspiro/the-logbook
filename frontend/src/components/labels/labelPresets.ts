...
export const LABEL_PRESETS: LabelPreset[] = [
  ...
  // Zebra stock. Sizes overlap the Rollo entries deliberately — a preset is
  // chosen by matching the box the labels came in, not by knowing that Zebra
  // 2x1 and a Rollo roll are the same size. These are also the sizes the
  // direct-to-printer (ZPL) path prints natively.
  {
    id: 'zebra_2x1',
    name: 'Zebra 2" x 1"',
    description: '2" x 1" — Asset label',
    width: '2in',
    height: '1in',
    barcodeHeight: 32,
    barcodeWidth: 1,
  ...
  },
  {
    id: 'zebra_3x1',
    name: 'Zebra 3" x 1"',
    description: '3" x 1" — Wide asset label',
    width: '3in',
    height: '1in',
    barcodeHeight: 34,
    barcodeWidth: 1.3,
  ...
  },
  {
    id: 'zebra_4x2',
    name: 'Zebra 4" x 2"',
    description: '4" x 2" — Equipment label',
    width: '4in',
    height: '2in',
    barcodeHeight: 48,
    barcodeWidth: 1.8,
