      ...
      <div className="bg-theme-surface backdrop-blur-sm rounded-lg shadow-md p-4 mb-6 flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex gap-2">
          ...
          <button
            ...
            className="px-4 py-2 border border-white/30 rounded-md text-sm font-medium text-red-700 dark:text-red-400 bg-theme-surface hover:bg-theme-surface-hover"
          >
            Clear All
          </button>
        </div>
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full divide-y divide-white/10">
              ...
              <tbody className="divide-y divide-white/10">
                {errors.map((error) => (
                  <tr key={error.id} className="hover:bg-theme-surface-secondary">
