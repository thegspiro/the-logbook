  ...
  const renderForm = () => (
    <div className="space-y-3 rounded-lg border border-violet-500/20 bg-violet-500/5 p-3">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
        ...
        <div>
          <label htmlFor="call-dispatched" className="text-theme-text-secondary mb-1 block text-xs font-medium">
            Dispatched
          </label>
          <input
            id="call-dispatched"
        ...
        <div>
          <label htmlFor="call-cleared" className="text-theme-text-secondary mb-1 block text-xs font-medium">
            Cleared
          </label>
          <input
            id="call-cleared"
      ...
      <div className="flex flex-wrap items-center gap-4">
        <label className="text-theme-text-secondary flex cursor-pointer items-center gap-2 text-xs select-none">
          <input
            type="checkbox"
      ...
      <div>
        <label htmlFor="call-notes" className="text-theme-text-secondary mb-1 block text-xs font-medium">
          Notes
        </label>
        <textarea
          id="call-notes"
      ...
      <div className="flex items-center justify-end gap-2">
        <button
          onClick={closeForm}
          className="text-theme-text-secondary hover:text-theme-text-primary inline-flex items-center gap-1.5 px-3 py-1.5 text-xs"
        >
  ...
  return (
    <div className="space-y-3">
      ...
      {loading ? (
        ...
        <p className="text-theme-text-muted text-xs">No calls logged for this shift.</p>
      ) : (
                ...
                <div className="min-w-0">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {call.incident_number && (
                      <span className="text-theme-text-muted text-xs">#{call.incident_number}</span>
                    )}
                    ...
                    {call.medical_refusal && (
                      <span className="rounded-full bg-blue-500/10 px-1.5 py-0.5 text-[10px] font-medium text-blue-700 dark:text-blue-400">
                        Refusal
                      </span>
                    )}
                  </div>
                  ...
                  {call.notes && <p className="text-theme-text-secondary mt-0.5 text-xs">{call.notes}</p>}
                </div>
                {canManage && (
                  <div className="flex shrink-0 items-center gap-1">
                    ...
                    <button
                      ...
                      className="rounded-lg p-1.5 text-red-500 transition-colors hover:bg-red-500/10 disabled:opacity-50 dark:text-red-400"
                      title="Remove call"
