  ...
  <div className="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-center">
    <div className="flex items-center space-x-3">
      {backTo && (
        <Link
          to={backTo}
          className="text-theme-text-muted hover:bg-theme-surface-hover hover:text-theme-text-primary focus-visible:ring-theme-focus rounded-lg p-2 transition-colors focus-visible:ring-2 focus-visible:outline-none"
