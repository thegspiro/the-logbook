...
const SubmissionForm: React.FC<SubmissionFormProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="bg-theme-surface border-theme-surface-border action-bar-safe fixed inset-x-0 bottom-0 z-30 flex items-center gap-3 border-t px-4 shadow-lg lg:hidden">
        <div className="min-w-0">
