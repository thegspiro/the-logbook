        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8" role="region" aria-label="Hours summary">
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-5 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-300 text-xs font-medium uppercase">Total Hours</p>
                {loadingHours ? (
                  <div className="mt-1 h-8 w-14 bg-slate-700/50 animate-pulse rounded"></div>
                ) : (
                  <p className="text-white text-2xl font-bold mt-1">{totalHours}</p>
                )}
              </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-5 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-300 text-xs font-medium uppercase">Training</p>
                {loadingHours ? (
                  <div className="mt-1 h-8 w-14 bg-slate-700/50 animate-pulse rounded"></div>
                ) : (
            ...
            <p className="text-slate-400 text-xs mt-2">Training hours</p>
          </div>

          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-5 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-300 text-xs font-medium uppercase">Standby</p>
                {loadingHours ? (
                  <div className="mt-1 h-8 w-14 bg-slate-700/50 animate-pulse rounded"></div>
                ) : (
            ...
            <p className="text-slate-400 text-xs mt-2">Standby hours</p>
          </div>

          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-5 border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-slate-300 text-xs font-medium uppercase">Administrative</p>
                {loadingHours ? (
                  <div className="mt-1 h-8 w-14 bg-slate-700/50 animate-pulse rounded"></div>
                ) : (
            ...
            <p className="text-slate-400 text-xs mt-2">Admin hours</p>
          </div>
        </div>
