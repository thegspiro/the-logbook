                ...
                <div className="flex items-center justify-between">
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex flex-wrap gap-1">
                      {role.permissions.slice(0, 5).map((perm) => (
                        <span
                          key={perm}
                          className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-theme-surface text-slate-200"
                        >
                          {perm.split('.').pop()}
                        </span>
                      ))}
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="text-blue-700 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium"
                    >
                      Edit
                    </button>
                    {!role.is_system && (
                      <button
                        ...
                        className="text-red-700 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 text-sm font-medium"
                      >
                        Delete
                      </button>
                    )}
