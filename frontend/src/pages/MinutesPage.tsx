    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-theme-surface backdrop-blur-sm rounded-lg p-4 border border-theme-surface-border">
          ...
          <p className="text-cyan-700 dark:text-cyan-400 text-2xl font-bold mt-1">{summary?.meetings_this_month ?? 0}</p>
        </div>
        <div className="bg-theme-surface backdrop-blur-sm rounded-lg p-4 border border-theme-surface-border">
          <p className="text-theme-text-muted text-xs font-medium uppercase">Open Action Items</p>
          <p className="text-yellow-700 dark:text-yellow-400 text-2xl font-bold mt-1">{summary?.open_action_items ?? 0}</p>
        </div>
        <div className="bg-theme-surface backdrop-blur-sm rounded-lg p-4 border border-theme-surface-border">
          <p className="text-theme-text-muted text-xs font-medium uppercase">Pending Approval</p>
          <p className="text-orange-700 dark:text-orange-400 text-2xl font-bold mt-1">{summary?.pending_approval ?? 0}</p>
        </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row items-center gap-4">
          <div className="relative flex-1 w-full md:max-w-md">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 bg-theme-input-bg border border-theme-input-border rounded-lg text-theme-text-primary placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-cyan-500"
            />
          </div>
          <div>
      ...
      {loading && (
        <div className="bg-theme-surface backdrop-blur-sm rounded-lg p-12 border border-theme-surface-border text-center">
          <Loader2 className="w-10 h-10 text-cyan-700 dark:text-cyan-400 mx-auto mb-4 animate-spin" />
                ...
                <div className="flex items-start justify-between">
                  ...
                  {canManage && (
                    <button
                      ...
                      className="ml-4 p-2 text-theme-text-muted hover:text-red-700 dark:hover:text-red-400 hover:bg-red-500/10 rounded-lg transition-colors disabled:opacity-50"
        ...
        <>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            <div className="bg-theme-surface backdrop-blur-sm rounded-lg p-6 border border-theme-surface-border">
              <ClipboardList className="w-8 h-8 text-cyan-700 dark:text-cyan-400 mb-4" />
              ...
              <div className="flex flex-wrap gap-1.5">
                <span className="px-2 py-0.5 text-xs bg-cyan-500/10 text-cyan-700 dark:text-cyan-400 rounded">Roll Call</span>
                <span className="px-2 py-0.5 text-xs bg-cyan-500/10 text-cyan-700 dark:text-cyan-400 rounded">Motions</span>
                <span className="px-2 py-0.5 text-xs bg-cyan-500/10 text-cyan-700 dark:text-cyan-400 rounded">Votes</span>
              </div>
            </div>
            <div className="bg-theme-surface backdrop-blur-sm rounded-lg p-6 border border-theme-surface-border">
              <CheckSquare className="w-8 h-8 text-green-700 dark:text-green-400 mb-4" />
              ...
              <div className="flex flex-wrap gap-1.5">
                <span className="px-2 py-0.5 text-xs bg-green-500/10 text-green-700 dark:text-green-400 rounded">Assignees</span>
                <span className="px-2 py-0.5 text-xs bg-green-500/10 text-green-700 dark:text-green-400 rounded">Due Dates</span>
                <span className="px-2 py-0.5 text-xs bg-green-500/10 text-green-700 dark:text-green-400 rounded">Follow-up</span>
              </div>
            </div>
            <div className="bg-theme-surface backdrop-blur-sm rounded-lg p-6 border border-theme-surface-border">
              <Archive className="w-8 h-8 text-amber-700 dark:text-amber-400 mb-4" />
              ...
              <div className="flex flex-wrap gap-1.5">
                <span className="px-2 py-0.5 text-xs bg-amber-500/10 text-amber-700 dark:text-amber-400 rounded">Full-text Search</span>
                <span className="px-2 py-0.5 text-xs bg-amber-500/10 text-amber-700 dark:text-amber-400 rounded">PDF Export</span>
              </div>
            </div>
          </div>
