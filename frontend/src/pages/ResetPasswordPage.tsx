...
export const ResetPasswordPage: React.FC = () => {
  ...
  if (isValidating) {
    return (
      <main className="min-h-screen flex items-center justify-center bg-linear-to-br from-theme-bg-from via-theme-bg-via to-theme-bg-to py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-md w-full">
          <div className="card p-8 text-center">
            ...
            <div className="space-y-3">
              ...
              <Link
                to="/login"
                className="block text-theme-text-secondary hover:text-theme-text-primary transition-colors focus:outline-hidden focus:ring-2 focus:ring-theme-focus-ring rounded-sm px-3 py-2"
              >
                Back to Login
              </Link>
            </div>
      ...
      <main className="min-h-screen flex items-center justify-center bg-linear-to-br from-theme-bg-from via-theme-bg-via to-theme-bg-to py-12 px-4 sm:px-6 lg:px-8">
        <div className="max-w-md w-full">
          <div className="card p-8 text-center">
            ...
            <Link
              to="/login"
              className="inline-flex items-center space-x-2 text-red-700 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 font-medium transition-colors focus:outline-hidden focus:ring-2 focus:ring-theme-focus-ring rounded-sm px-3 py-2"
            >
      ...
      <div className="max-w-md w-full">
        ...
        <div className="card p-8">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="block w-full pl-10 pr-10 py-2 border border-theme-surface-border rounded-md bg-theme-surface-secondary text-theme-text-primary placeholder-theme-text-muted focus:outline-hidden focus:ring-2 focus:ring-theme-focus-ring focus:border-transparent sm:text-sm"
                ...
                <button
                  ...
                  className="absolute inset-y-0 right-0 pr-3 flex items-center text-theme-text-muted hover:text-theme-text-primary focus:outline-hidden focus-visible:ring-2 focus-visible:ring-red-500 focus-visible:rounded-sm"
                    ...
                    {[
                      ...
                      <li key={idx} className="flex items-center space-x-2">
                        {check.valid ? (
                          ...
                          <div className="w-4 h-4 rounded-full border-2 border-theme-input-border shrink-0" aria-hidden="true" />
                        )}
          ...
          <div className="mt-6 text-center">
            <Link
              to="/login"
              className="inline-flex items-center space-x-2 text-sm text-theme-text-secondary hover:text-theme-text-primary transition-colors focus:outline-hidden focus:ring-2 focus:ring-theme-focus-ring rounded-sm px-3 py-2"
            >
