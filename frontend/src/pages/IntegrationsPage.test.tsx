...
describe('IntegrationsPage', () => {
  ...
  it('shows Connected badge on connected integrations', async () => {
    ...
    const epcrCard = screen.getByText('Generic ePCR Import').closest('.stat-card') as HTMLElement ?? document.body;
  ...
  it('opens connect modal with config form for webhook type', async () => {
    ...
    const slackCard = screen.getByText('Slack').closest('.stat-card') as HTMLElement ?? document.body;
