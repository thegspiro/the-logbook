        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center space-x-3">
            <div className="bg-amber-600 rounded-lg p-2">
              <FileText className="w-6 h-6 text-theme-text-primary" aria-hidden="true" />
            </div>
            <div>
        ...
        <div className="bg-theme-surface backdrop-blur-sm rounded-lg p-4 border border-theme-surface-border mb-6" role="search" aria-label="Search documents">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              <div className="flex bg-theme-input-bg rounded-lg p-1" role="group" aria-label="View mode">
                <button
                  onClick={() => setViewMode('grid')}
                  className={`p-2 rounded ${viewMode === 'grid' ? 'bg-amber-600 text-white' : 'text-theme-text-muted hover:text-white'}`}
                ...
                <button
                  ...
                  className={`p-2 rounded ${viewMode === 'list' ? 'bg-amber-600 text-white' : 'text-theme-text-muted hover:text-white'}`}
              ...
              viewMode === 'grid' ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                  {filteredDocuments.map((doc) => (
                    ...
                    >
                      <div className="flex items-start space-x-3">
                        <File className="w-8 h-8 text-amber-700 dark:text-amber-400 flex-shrink-0" />
                        <div className="flex-1 min-w-0">
                        ...
                        {canManage && (
                          <button
                            ...
                            className="opacity-0 group-hover:opacity-100 text-theme-text-muted hover:text-red-700 dark:hover:text-red-400 transition-all p-1"
                ...
                <div className="bg-theme-surface backdrop-blur-sm rounded-lg border border-theme-surface-border overflow-hidden">
                  <table className="w-full">
                    ...
                    <tbody>
                      {filteredDocuments.map((doc) => (
                        <tr key={doc.id} className="border-b border-white/5 hover:bg-theme-surface-secondary transition-colors">
                          <td className="px-4 py-3">
                            <div className="flex items-center space-x-2">
                              <File className="w-4 h-4 text-amber-700 dark:text-amber-400 flex-shrink-0" />
                              <div>
                          ...
                          {canManage && (
                            <td className="px-4 py-3 text-right">
                              <button
                                ...
                                className="text-theme-text-muted hover:text-red-700 dark:hover:text-red-400 transition-colors p-1"
                                title="Delete document"
                              >
                                <Trash2 className="w-4 h-4" />
                              </button>
              ...
              <div className="relative bg-theme-surface rounded-lg shadow-xl max-w-lg w-full border border-theme-surface-border">
                <div className="px-6 pt-5 pb-4">
                  ...
                  <div className="space-y-4">
                    <div className="border-2 border-dashed border-theme-input-border rounded-lg p-8 text-center hover:border-amber-500/50 transition-colors">
                ...
                <div className="bg-theme-input-bg px-6 py-3 flex justify-end space-x-3 rounded-b-lg">
                  ...
                  <button
                    ...
                    className={`px-4 py-2 rounded-lg text-theme-text-primary transition-colors inline-flex items-center space-x-2 ${
