...
export const SchedulingReportsPage: React.FC = () => {
  ...
  return (
    <div className="p-6 max-w-7xl mx-auto">
      ...
      {/* Tabs */}
      <div className="flex border-b border-theme-surface-border mb-6 overflow-x-auto [&>button]:shrink-0 [&>button]:whitespace-nowrap" role="tablist" aria-label="Scheduling reports">
        <button
