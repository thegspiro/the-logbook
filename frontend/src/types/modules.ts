...
export const AVAILABLE_MODULES: Module[] = [
  ...
  },
  {
    ...
    description: 'Grant tracking, fundraising campaigns, donor management, and compliance reporting',
    longDescription:
      'Comprehensive grant and fundraising management for fire departments. Track federal grant applications (AFG, SAFER, FP&S) through the full pipeline from research to closeout. Manage fundraising campaigns, donor relationships, and donations. Auto-generate compliance tasks and performance report schedules for awarded grants. Monitor budget expenditures and generate financial reports.',
    category: 'optional',
    enabled: false,
    canDisable: true,
    icon: 'DollarSign',
    ...
    features: [
      ...
      'Grant opportunity library with deadline alerts',
      'Budget and expenditure tracking per grant',
      'Compliance task auto-generation and follow-up',
      'Fundraising campaign management with progress tracking',
      'Donor CRM with giving history',
      'Donation recording and receipt tracking',
      'Pledge management',
