...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "billing_cycle", sa.String(20), nullable=True, server_default="monthly"
        ),
    ...
    op.create_index(
        "idx_facility_utility_facility", "facility_utility_accounts", ["facility_id"]
    )
    op.create_index(
        "idx_facility_utility_type",
        "facility_utility_accounts",
        ["facility_id", "utility_type"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "utility_account_id",
            sa.String(36),
            sa.ForeignKey("facility_utility_accounts.id", ondelete="CASCADE"),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_facility_utility_readings_date",
        "facility_utility_readings",
        ["reading_date"],
    )
    ...
    op.create_index(
        "idx_facility_access_keys_facility", "facility_access_keys", ["facility_id"]
    )
    op.create_index(
        "idx_facility_access_keys_user", "facility_access_keys", ["assigned_to_user_id"]
    )
    op.create_index(
        "idx_facility_access_keys_type", "facility_access_keys", ["key_type"]
    )
    ...
    op.create_index(
        "idx_facility_rooms_floor", "facility_rooms", ["facility_id", "floor"]
    )
    ...
    op.create_index(
        "idx_facility_emerg_contacts_type",
        "facility_emergency_contacts",
        ["contact_type"],
    )
    ...
    op.create_index(
        "idx_facility_shutoffs_facility", "facility_shutoff_locations", ["facility_id"]
    )
    op.create_index(
        "idx_facility_shutoffs_type", "facility_shutoff_locations", ["shutoff_type"]
    )
    ...
    op.create_table(
        ...
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column(
            "project_type", sa.String(30), nullable=False, server_default="other"
        ),
        sa.Column(
            "project_status", sa.String(20), nullable=False, server_default="planning"
        ),
    ...
    op.create_index(
        "idx_facility_capital_facility", "facility_capital_projects", ["facility_id"]
    )
    op.create_index(
        "idx_facility_capital_status", "facility_capital_projects", ["project_status"]
    )
    op.create_index(
        "idx_facility_capital_type", "facility_capital_projects", ["project_type"]
    )
    ...
    op.create_index(
        "idx_facility_insurance_type", "facility_insurance_policies", ["policy_type"]
    )
    op.create_index(
        "idx_facility_insurance_expiration",
        "facility_insurance_policies",
        ["expiration_date"],
    )
    ...
    op.create_index(
        "idx_facility_occupants_facility", "facility_occupants", ["facility_id"]
    )
    op.create_index(
        "idx_facility_occupants_active", "facility_occupants", ["is_active"]
    )
    ...
    op.create_index(
        "idx_facility_compliance_type",
        "facility_compliance_checklists",
        ["compliance_type"],
    )
    op.create_index(
        "idx_facility_compliance_due", "facility_compliance_checklists", ["due_date"]
    )
    op.create_index(
        "idx_facility_compliance_completed",
        "facility_compliance_checklists",
        ["is_completed"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "checklist_id",
            sa.String(36),
            sa.ForeignKey("facility_compliance_checklists.id", ondelete="CASCADE"),
            nullable=False,
        ),
