...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            "review_status", sa.String(20), nullable=False, server_default="approved"
        ),
    )
    op.add_column(
        "shift_completion_reports",
    ...
    op.add_column(
        ...
        sa.Column(
            "report_review_required", sa.Boolean(), nullable=False, server_default="0"
        ),
    )
    op.add_column(
        "training_module_configs",
        sa.Column(
            ...
            sa.String(50),
            nullable=False,
            server_default="training_officer",
        ),
    )
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.String(100),
            nullable=False,
            server_default="Performance Rating",
        ),
    )
    op.add_column(
        "training_module_configs",
        sa.Column(
            "rating_scale_type", sa.String(20), nullable=False, server_default="stars"
        ),
    )
    op.add_column(
        "training_module_configs",
