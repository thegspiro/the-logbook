...
def upgrade() -> None:
    ...
    op.add_column(
        "meeting_minutes", sa.Column("quorum_threshold", sa.Float(), nullable=True)
    )
    op.add_column(
        "meeting_minutes", sa.Column("quorum_type", sa.String(20), nullable=True)
    )
    ...
    op.add_column(
        "skill_evaluations", sa.Column("allowed_evaluators", sa.JSON(), nullable=True)
    )
    ...
    op.add_column(
        "training_records", sa.Column("alert_90_sent_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "training_records", sa.Column("alert_60_sent_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "training_records", sa.Column("alert_30_sent_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "training_records", sa.Column("alert_7_sent_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "training_records",
