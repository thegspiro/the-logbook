...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "deadline_type",
            sa.Enum("fixed", "recurring", "rolling", name="deadlinetype"),
        ),
    ...
    op.create_index(
        "ix_grant_opportunities_organization_id",
        "grant_opportunities",
        ["organization_id"],
    )
    op.create_index(
        "ix_grant_opportunities_category", "grant_opportunities", ["category"]
    )
    op.create_index(
        "ix_grant_opportunities_is_active", "grant_opportunities", ["is_active"]
    )
    op.create_index(
        "ix_grant_opportunities_deadline_date", "grant_opportunities", ["deadline_date"]
    )
    op.create_index(
        "ix_grant_opportunities_federal_program_code",
        "grant_opportunities",
    ...
    op.create_table(
        ...
        sa.Column(
            "opportunity_id",
            sa.String(36),
            sa.ForeignKey("grant_opportunities.id", ondelete="SET NULL"),
        ),
        ...
        sa.Column(
            "assigned_to", sa.String(36), sa.ForeignKey("users.id", ondelete="SET NULL")
        ),
        sa.Column(
            "priority",
            sa.Enum("low", "medium", "high", "critical", name="grantpriority"),
            nullable=False,
        ...
        sa.Column(
            "linked_campaign_id",
            sa.String(36),
            sa.ForeignKey("fundraising_campaigns.id", ondelete="SET NULL"),
        ),
        sa.Column("notes", sa.Text()),
        sa.Column("created_by", sa.String(36), sa.ForeignKey("users.id")),
        sa.Column(
    ...
    op.create_index(
        "ix_grant_applications_organization_id",
        "grant_applications",
        ["organization_id"],
    )
    op.create_index(
        "ix_grant_applications_opportunity_id", "grant_applications", ["opportunity_id"]
    )
    op.create_index(
        "ix_grant_applications_status", "grant_applications", ["application_status"]
    )
    op.create_index(
        "ix_grant_applications_assigned_to", "grant_applications", ["assigned_to"]
    )
    op.create_index(
        "ix_grant_applications_priority", "grant_applications", ["priority"]
    )
    op.create_index(
        "ix_grant_applications_deadline", "grant_applications", ["application_deadline"]
    )
    op.create_index(
        "ix_grant_applications_linked_campaign_id",
        "grant_applications",
        ["linked_campaign_id"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "amount_spent", sa.Numeric(12, 2), nullable=False, server_default="0.00"
        ),
    ...
    op.create_index(
        "ix_grant_budget_items_application_id", "grant_budget_items", ["application_id"]
    )
    op.create_index(
        "ix_grant_budget_items_category", "grant_budget_items", ["category"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "budget_item_id",
            sa.String(36),
            sa.ForeignKey("grant_budget_items.id", ondelete="SET NULL"),
        ),
        ...
        sa.Column(
            "approved_by", sa.String(36), sa.ForeignKey("users.id", ondelete="SET NULL")
        ),
    ...
    op.create_index(
        "ix_grant_expenditures_application_id", "grant_expenditures", ["application_id"]
    )
    op.create_index(
        "ix_grant_expenditures_budget_item_id", "grant_expenditures", ["budget_item_id"]
    )
    op.create_index(
        "ix_grant_expenditures_expenditure_date",
        "grant_expenditures",
        ["expenditure_date"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "reminder_days_before", sa.Integer(), nullable=False, server_default="14"
        ),
    ...
    op.create_index(
        "ix_grant_compliance_tasks_application_id",
        "grant_compliance_tasks",
        ["application_id"],
    )
    op.create_index(
        "ix_grant_compliance_tasks_status", "grant_compliance_tasks", ["status"]
    )
    op.create_index(
        "ix_grant_compliance_tasks_due_date", "grant_compliance_tasks", ["due_date"]
    )
    op.create_index(
        "ix_grant_compliance_tasks_assigned_to",
        "grant_compliance_tasks",
        ["assigned_to"],
    )
