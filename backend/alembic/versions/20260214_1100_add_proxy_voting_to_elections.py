...
def upgrade() -> None:
    ...
    op.add_column(
        "elections", sa.Column("proxy_authorizations", sa.JSON(), nullable=True)
    )
    ...
    op.add_column(
        "votes",
        sa.Column(
            "is_proxy_vote", sa.Boolean(), nullable=False, server_default=sa.text("0")
        ),
    )
    op.add_column("votes", sa.Column("proxy_voter_id", sa.String(36), nullable=True))
    op.add_column(
        "votes", sa.Column("proxy_authorization_id", sa.String(36), nullable=True)
    )
    op.add_column(
        "votes", sa.Column("proxy_delegating_user_id", sa.String(36), nullable=True)
    )
