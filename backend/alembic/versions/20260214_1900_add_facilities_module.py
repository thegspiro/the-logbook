...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "is_operational", sa.Boolean(), nullable=False, server_default=sa.text("1")
        ),
        sa.Column(
            "is_system", sa.Boolean(), nullable=False, server_default=sa.text("0")
        ),
    ...
    op.create_index(
        "idx_facility_statuses_org", "facility_statuses", ["organization_id"]
    )
    op.create_index(
        "idx_facility_statuses_org_name",
        "facility_statuses",
        ["organization_id", "name"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "facility_type_id",
            sa.String(36),
            sa.ForeignKey("facility_types.id"),
            nullable=False,
        ),
        sa.Column(
            "status_id",
            sa.String(36),
            sa.ForeignKey("facility_statuses.id"),
            nullable=False,
        ),
        # Address
        ...
        # Ownership
        sa.Column(
            "is_owned", sa.Boolean(), nullable=False, server_default=sa.text("1")
        ),
    ...
    op.create_index(
        ...
        "facilities",
        ["organization_id", "facility_number"],
        unique=True,
    )
    op.create_index(
        "idx_facilities_org_type", "facilities", ["organization_id", "facility_type_id"]
    )
    op.create_index(
        "idx_facilities_org_status", "facilities", ["organization_id", "status_id"]
    )
    ...
    op.create_index(
        "idx_facility_documents_facility", "facility_documents", ["facility_id"]
    )
    op.create_index(
        "idx_facility_documents_type", "facility_documents", ["document_type"]
    )
    op.create_index(
        "idx_facility_documents_expiration", "facility_documents", ["expiration_date"]
    )
    ...
    op.create_index(
        "idx_facility_maint_types_org_name",
        "facility_maintenance_types",
        ["organization_id", "name"],
        unique=True,
    )
    ...
    op.create_index(
        "idx_facility_systems_facility", "facility_systems", ["facility_id"]
    )
    op.create_index(
        "idx_facility_systems_type", "facility_systems", ["facility_id", "system_type"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "maintenance_type_id",
            sa.String(36),
            sa.ForeignKey("facility_maintenance_types.id"),
            nullable=False,
        ),
        sa.Column(
            "system_id",
            sa.String(36),
            sa.ForeignKey("facility_systems.id", ondelete="SET NULL"),
            nullable=True,
        ),
        # Scheduling
        ...
        sa.Column(
            "is_overdue", sa.Boolean(), nullable=False, server_default=sa.text("0")
        ),
        # Details
        sa.Column("description", sa.Text(), nullable=True),
        ...
        sa.Column(
            "is_historic", sa.Boolean(), nullable=False, server_default=sa.text("0")
        ),
    ...
    op.create_index(
        "idx_facility_maint_facility", "facility_maintenance", ["facility_id"]
    )
    op.create_index(
        "idx_facility_maint_type", "facility_maintenance", ["maintenance_type_id"]
    )
    ...
    op.create_index(
        "idx_facility_maint_completed", "facility_maintenance", ["is_completed"]
    )
    op.create_index(
        "idx_facility_maint_overdue", "facility_maintenance", ["is_overdue"]
    )
    op.create_index(
        "idx_facility_maint_historic", "facility_maintenance", ["is_historic"]
    )
    op.create_index(
        "idx_facility_maint_occurred", "facility_maintenance", ["occurred_date"]
    )
    ...
    op.create_index(
        "idx_facility_inspections_facility", "facility_inspections", ["facility_id"]
    )
    op.create_index(
        "idx_facility_inspections_type", "facility_inspections", ["inspection_type"]
    )
    op.create_index(
        "idx_facility_inspections_date", "facility_inspections", ["inspection_date"]
    )
    op.create_index(
        "idx_facility_inspections_next",
        "facility_inspections",
        ["next_inspection_date"],
    )
    op.create_index(
        "idx_facility_inspections_passed", "facility_inspections", ["passed"]
    )
