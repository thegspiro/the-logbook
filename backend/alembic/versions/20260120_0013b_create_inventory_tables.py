...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "requires_assignment", sa.Boolean(), nullable=False, server_default="0"
        ),
        sa.Column(
            "requires_serial_number", sa.Boolean(), nullable=False, server_default="0"
        ),
        sa.Column(
            "requires_maintenance", sa.Boolean(), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        "idx_inventory_categories_org_type",
        "inventory_categories",
        ["organization_id", "item_type"],
    )
    op.create_index(
        "idx_inventory_categories_org_active",
        "inventory_categories",
    ...
    op.create_index(
        "idx_inventory_items_org_category",
        "inventory_items",
        ["organization_id", "category_id"],
    )
    op.create_index(
        "idx_inventory_items_org_status",
        "inventory_items",
        ["organization_id", "status"],
    )
    op.create_index(
        "idx_inventory_items_org_active",
        "inventory_items",
        ["organization_id", "active"],
    )
    op.create_index(
        "idx_inventory_items_assigned_to", "inventory_items", ["assigned_to_user_id"]
    )
    op.create_index(
        "idx_inventory_items_next_inspection",
        "inventory_items",
        ["next_inspection_due"],
    )
    op.create_index("idx_inventory_items_name", "inventory_items", ["name"])
    op.create_index(
        "idx_inventory_items_serial_number", "inventory_items", ["serial_number"]
    )
    op.create_index("idx_inventory_items_condition", "inventory_items", ["condition"])
    op.create_index(
        "idx_inventory_items_category_id", "inventory_items", ["category_id"]
    )
    op.create_index(
        "idx_inventory_items_asset_tag", "inventory_items", ["asset_tag"], unique=True
    )
    op.create_index(
        "idx_inventory_items_barcode", "inventory_items", ["barcode"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "assignment_type",
            sa.Enum("permanent", "temporary", name="assignmenttype"),
            nullable=False,
        ...
        sa.Column(
            "assigned_by", sa.String(36), sa.ForeignKey("users.id"), nullable=True
        ),
        sa.Column(
    ...
    op.create_index(
        "idx_item_assignments_org_item",
        "item_assignments",
        ["organization_id", "item_id"],
    )
    op.create_index(
        "idx_item_assignments_org_user",
        "item_assignments",
        ["organization_id", "user_id"],
    )
    op.create_index(
        "idx_item_assignments_org_active",
        "item_assignments",
    ...
    op.create_table(
        ...
        sa.Column(
            "checked_out_by", sa.String(36), sa.ForeignKey("users.id"), nullable=True
        ),
        sa.Column(
            "checked_in_by", sa.String(36), sa.ForeignKey("users.id"), nullable=True
        ),
    ...
    op.create_index(
        "idx_checkout_records_org_item",
        "checkout_records",
        ["organization_id", "item_id"],
    )
    op.create_index(
        "idx_checkout_records_org_user",
        "checkout_records",
        ["organization_id", "user_id"],
    )
    op.create_index(
    ...
    op.create_index(
        "idx_checkout_records_org_overdue",
        "checkout_records",
        ["organization_id", "is_overdue"],
    )
    op.create_index(
        "idx_checkout_records_checked_in_at", "checkout_records", ["checked_in_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "performed_by", sa.String(36), sa.ForeignKey("users.id"), nullable=True
        ),
    ...
    op.create_index(
        "idx_maintenance_records_org_item",
        "maintenance_records",
        ["organization_id", "item_id"],
    )
    op.create_index(
        "idx_maintenance_records_org_scheduled",
        "maintenance_records",
        ["organization_id", "scheduled_date"],
    )
    op.create_index(
        "idx_maintenance_records_org_next_due",
        "maintenance_records",
        ["organization_id", "next_due_date"],
    )
    op.create_index(
        "idx_maintenance_records_org_completed",
        "maintenance_records",
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_maintenance_records_org_completed", table_name="maintenance_records"
    )
    op.drop_index(
        "idx_maintenance_records_org_next_due", table_name="maintenance_records"
    )
    op.drop_index(
        "idx_maintenance_records_org_scheduled", table_name="maintenance_records"
    )
    ...
    op.drop_index(
        "idx_inventory_categories_org_active", table_name="inventory_categories"
    )
    op.drop_index(
        "idx_inventory_categories_org_type", table_name="inventory_categories"
    )
