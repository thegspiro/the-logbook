...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("active", "archived", name="documentstatus"),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("draft", "pending_approval", "approved", name="meetingstatus"),
            nullable=False,
    ...
    op.create_index(
        "idx_meetings_org_date", "meetings", ["organization_id", "meeting_date"]
    )
    op.create_index(
        "idx_meetings_org_type", "meetings", ["organization_id", "meeting_type"]
    )
    op.create_index(
        "idx_meetings_org_status", "meetings", ["organization_id", "status"]
    )
    ...
    op.create_index(
        "idx_meeting_attendees_meeting", "meeting_attendees", ["meeting_id"]
    )
    ...
    op.create_index(
        "idx_action_items_org_status",
        "meeting_action_items",
        ["organization_id", "status"],
    )
    op.create_index(
        "idx_action_items_assigned", "meeting_action_items", ["assigned_to", "status"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "channel",
            sa.Enum("email", "in_app", name="notificationchannel"),
            nullable=False,
    ...
    op.create_index(
        "idx_notif_rules_org_trigger",
        "notification_rules",
        ["organization_id", "trigger"],
    )
    op.create_index(
        "idx_notif_rules_org_enabled",
        "notification_rules",
    ...
    op.create_table(
        ...
        sa.Column(
            "channel",
            sa.Enum("email", "in_app", name="notificationchannel", create_type=False),
            nullable=False,
        ),
    ...
    op.create_index(
        "idx_notif_logs_org_sent", "notification_logs", ["organization_id", "sent_at"]
    )
