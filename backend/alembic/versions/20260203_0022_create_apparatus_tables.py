...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "is_archived_status", sa.Boolean(), nullable=False, server_default="0"
        ),
        sa.Column("color", sa.String(20), nullable=True),
        sa.Column("icon", sa.String(50), nullable=True),
        sa.Column("sort_order", sa.Integer(), nullable=True, server_default="0"),
    ...
    op.create_index(
        "idx_apparatus_statuses_org_code",
        "apparatus_statuses",
        ["organization_id", "code"],
        unique=True,
    )
    op.create_index(
        "idx_apparatus_statuses_is_system", "apparatus_statuses", ["is_system"]
    )
    op.create_index(
        "idx_apparatus_statuses_is_available", "apparatus_statuses", ["is_available"]
    )
    ...
    op.create_table(
        ...
        # NFPA
        sa.Column(
            "nfpa_tracking_enabled", sa.Boolean(), nullable=False, server_default="0"
        ),
        # Custom Fields
    ...
    op.create_index(
        "idx_apparatus_org_unit",
        "apparatus",
        ["organization_id", "unit_number"],
        unique=True,
    )
    op.create_index(
        "idx_apparatus_org_type", "apparatus", ["organization_id", "apparatus_type_id"]
    )
    op.create_index(
        "idx_apparatus_org_status", "apparatus", ["organization_id", "status_id"]
    )
    op.create_index(
        "idx_apparatus_org_station",
        "apparatus",
        ["organization_id", "primary_station_id"],
    )
    ...
    op.create_index(
        "idx_apparatus_custom_fields_org_active",
        "apparatus_custom_fields",
    ...
    op.create_index(
        "idx_apparatus_photos_apparatus", "apparatus_photos", ["apparatus_id"]
    )
    op.create_index(
        "idx_apparatus_photos_is_primary",
        "apparatus_photos",
        ["apparatus_id", "is_primary"],
    )
    ...
    op.create_index(
        "idx_apparatus_documents_apparatus", "apparatus_documents", ["apparatus_id"]
    )
    op.create_index(
        "idx_apparatus_documents_type",
        "apparatus_documents",
        ["apparatus_id", "document_type"],
    )
    op.create_index(
        "idx_apparatus_documents_expiration", "apparatus_documents", ["expiration_date"]
    )
    ...
    op.create_index(
        "idx_apparatus_maint_types_org_code",
        "apparatus_maintenance_types",
        ["organization_id", "code"],
        unique=True,
    )
    op.create_index(
        "idx_apparatus_maint_types_category",
        "apparatus_maintenance_types",
        ["category"],
    )
    op.create_index(
        "idx_apparatus_maint_types_is_system",
        "apparatus_maintenance_types",
        ["is_system"],
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(["apparatus_id"], ["apparatus.id"], ondelete="CASCADE"),
        sa.ForeignKeyConstraint(
            ["maintenance_type_id"], ["apparatus_maintenance_types.id"]
        ),
    ...
    op.create_index(
        "idx_apparatus_maint_apparatus", "apparatus_maintenance", ["apparatus_id"]
    )
    op.create_index(
        "idx_apparatus_maint_type", "apparatus_maintenance", ["maintenance_type_id"]
    )
    op.create_index(
        "idx_apparatus_maint_due_date", "apparatus_maintenance", ["due_date"]
    )
    op.create_index(
        "idx_apparatus_maint_completed", "apparatus_maintenance", ["is_completed"]
    )
    op.create_index(
        "idx_apparatus_maint_overdue", "apparatus_maintenance", ["is_overdue"]
    )
    ...
    op.create_index(
        "idx_apparatus_fuel_apparatus", "apparatus_fuel_logs", ["apparatus_id"]
    )
    ...
    op.create_index(
        "idx_apparatus_operators_apparatus", "apparatus_operators", ["apparatus_id"]
    )
    op.create_index("idx_apparatus_operators_user", "apparatus_operators", ["user_id"])
    op.create_index(
        "idx_apparatus_operators_apparatus_user",
        "apparatus_operators",
        ["apparatus_id", "user_id"],
        unique=True,
    )
    op.create_index(
        "idx_apparatus_operators_active", "apparatus_operators", ["is_active"]
    )
    ...
    op.create_index(
        "idx_apparatus_equipment_apparatus", "apparatus_equipment", ["apparatus_id"]
    )
    op.create_index(
        "idx_apparatus_equipment_inventory",
        "apparatus_equipment",
        ["inventory_item_id"],
    )
    ...
    op.create_index(
        "idx_apparatus_loc_hist_location", "apparatus_location_history", ["location_id"]
    )
    op.create_index(
        "idx_apparatus_loc_hist_dates",
        "apparatus_location_history",
    ...
    op.create_index(
        "idx_apparatus_status_hist_status", "apparatus_status_history", ["status_id"]
    )
    op.create_index(
        "idx_apparatus_status_hist_changed", "apparatus_status_history", ["changed_at"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "compliance_status", sa.String(50), nullable=True, server_default="pending"
        ),
    ...
    op.create_index(
        "idx_apparatus_nfpa_apparatus", "apparatus_nfpa_compliance", ["apparatus_id"]
    )
    op.create_index(
        "idx_apparatus_nfpa_standard", "apparatus_nfpa_compliance", ["standard_code"]
    )
    op.create_index(
        "idx_apparatus_nfpa_status", "apparatus_nfpa_compliance", ["compliance_status"]
    )
    op.create_index(
        "idx_apparatus_nfpa_due", "apparatus_nfpa_compliance", ["next_due_date"]
    )
    ...
    op.create_index(
        "idx_apparatus_report_configs_scheduled",
        "apparatus_report_configs",
        ["is_scheduled"],
    )
    op.create_index(
        "idx_apparatus_report_configs_next_run",
        "apparatus_report_configs",
        ["next_run_date"],
    )
...
def downgrade() -> None:
    ...
    op.drop_index(
        "idx_apparatus_report_configs_next_run", table_name="apparatus_report_configs"
    )
    op.drop_index(
        "idx_apparatus_report_configs_scheduled", table_name="apparatus_report_configs"
    )
    op.drop_index(
        "idx_apparatus_report_configs_org", table_name="apparatus_report_configs"
    )
    ...
    op.drop_index(
        "idx_apparatus_nfpa_apparatus", table_name="apparatus_nfpa_compliance"
    )
    op.drop_table("apparatus_nfpa_compliance")

    op.drop_index(
        "idx_apparatus_status_hist_changed", table_name="apparatus_status_history"
    )
    op.drop_index(
        "idx_apparatus_status_hist_status", table_name="apparatus_status_history"
    )
    op.drop_index(
        "idx_apparatus_status_hist_apparatus", table_name="apparatus_status_history"
    )
    op.drop_table("apparatus_status_history")

    op.drop_index(
        "idx_apparatus_loc_hist_dates", table_name="apparatus_location_history"
    )
    op.drop_index(
        "idx_apparatus_loc_hist_location", table_name="apparatus_location_history"
    )
    op.drop_index(
        "idx_apparatus_loc_hist_apparatus", table_name="apparatus_location_history"
    )
    ...
    op.drop_index(
        "idx_apparatus_operators_apparatus_user", table_name="apparatus_operators"
    )
    ...
    op.drop_index(
        "idx_apparatus_maint_types_is_system", table_name="apparatus_maintenance_types"
    )
    op.drop_index(
        "idx_apparatus_maint_types_category", table_name="apparatus_maintenance_types"
    )
    op.drop_index(
        "idx_apparatus_maint_types_org_code", table_name="apparatus_maintenance_types"
    )
    op.drop_table("apparatus_maintenance_types")

    op.drop_index(
        "idx_apparatus_documents_expiration", table_name="apparatus_documents"
    )
    ...
    op.drop_index(
        "idx_apparatus_custom_fields_org_active", table_name="apparatus_custom_fields"
    )
    op.drop_index(
        "idx_apparatus_custom_fields_org_key", table_name="apparatus_custom_fields"
    )
    ...
    op.drop_index(
        "idx_apparatus_statuses_is_available", table_name="apparatus_statuses"
    )
