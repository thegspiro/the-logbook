...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            "source",
            sa.Enum("department", "state", "national", name="requirementsource"),
            nullable=False,
    ...
    op.add_column(
        "training_requirements",
        sa.Column("registry_name", sa.String(100), nullable=True),
    )
    op.add_column(
        "training_requirements",
        sa.Column("registry_code", sa.String(50), nullable=True),
    )
    op.add_column(
        "training_requirements",
        sa.Column("is_editable", sa.Boolean(), nullable=True, server_default="1"),
    )
    op.add_column(
        "training_requirements",
        sa.Column("required_shifts", sa.Integer(), nullable=True),
    )
    op.add_column(
        "training_requirements",
        sa.Column("required_calls", sa.Integer(), nullable=True),
    )
    op.add_column(
        "training_requirements",
        sa.Column("required_call_types", sa.JSON(), nullable=True),
    )
    op.add_column(
        "training_requirements", sa.Column("required_skills", sa.JSON(), nullable=True)
    )
    op.add_column(
        "training_requirements", sa.Column("checklist_items", sa.JSON(), nullable=True)
    )
    op.add_column(
        "training_requirements",
        sa.Column("required_positions", sa.JSON(), nullable=True),
    )
    op.add_column(
        "training_requirements",
    ...
    # Update indexes
    op.create_index(
        "idx_requirement_org_source",
        "training_requirements",
        ["organization_id", "source"],
    )
    op.create_index(
        "idx_requirement_type", "training_requirements", ["requirement_type"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "structure_type",
            sa.Enum("sequential", "phases", "flexible", name="programstructuretype"),
            nullable=False,
            server_default="flexible",
        ),
        sa.Column("time_limit_days", sa.Integer(), nullable=True),
        sa.Column(
            "warning_days_before", sa.Integer(), nullable=True, server_default="30"
        ),
    ...
    op.create_index(
        "idx_program_org_active", "training_programs", ["organization_id", "active"]
    )
    ...
    op.create_index(
        "idx_phase_program", "program_phases", ["program_id", "phase_number"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["phase_id"], ["program_phases.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["requirement_id"], ["training_requirements.id"], ondelete="CASCADE"
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "requires_verification", sa.Boolean(), nullable=True, server_default="0"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "progress_percentage", sa.Float(), nullable=True, server_default="0.0"
        ),
        sa.Column(
            "status",
            sa.Enum(
                "active", "completed", "expired", "withdrawn", name="enrollmentstatus"
            ),
            nullable=True,
        ...
        sa.Column(
            "deadline_warning_sent", sa.Boolean(), nullable=True, server_default="0"
        ),
        sa.Column("deadline_warning_sent_at", sa.DateTime(), nullable=True),
        sa.Column(
            "created_at",
            sa.DateTime(),
            server_default=sa.text("CURRENT_TIMESTAMP"),
        ...
        sa.ForeignKeyConstraint(
            ["current_phase_id"], ["program_phases.id"], ondelete="SET NULL"
        ),
        sa.ForeignKeyConstraint(["enrolled_by"], ["users.id"]),
    )
    op.create_index("idx_enrollment_user", "program_enrollments", ["user_id", "status"])
    op.create_index(
        "idx_enrollment_program", "program_enrollments", ["program_id", "status"]
    )
    op.create_index(
        "idx_enrollment_deadline", "program_enrollments", ["target_completion_date"]
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["enrollment_id"], ["program_enrollments.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(
            ["requirement_id"], ["training_requirements.id"], ondelete="CASCADE"
        ),
    ...
    op.create_index(
        "idx_progress_enrollment", "requirement_progress", ["enrollment_id", "status"]
    )
    op.create_index(
        "idx_progress_requirement", "requirement_progress", ["requirement_id"]
    )
    ...
    op.create_index(
        "idx_skill_org_category", "skill_evaluations", ["organization_id", "category"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "cancelled_en_route", sa.Boolean(), nullable=True, server_default="0"
        ),
