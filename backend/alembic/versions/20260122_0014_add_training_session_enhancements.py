...
def upgrade() -> None:
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.Enum("flexible", "strict", "window", name="checkinwindowtype"),
            nullable=False,
    ...
    op.add_column(
        "events",
        sa.Column(
            "check_in_minutes_before", sa.Integer(), nullable=True, server_default="15"
        ),
    )
    op.add_column(
        "events",
        sa.Column(
            "check_in_minutes_after", sa.Integer(), nullable=True, server_default="15"
        ),
    )
    op.add_column(
        "events",
        sa.Column("require_checkout", sa.Boolean(), nullable=False, server_default="0"),
    )

    # Add check-out and duration tracking to event_rsvps table
    op.add_column(
        "event_rsvps", sa.Column("checked_out_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "event_rsvps",
    ...
    op.add_column(
        "event_rsvps", sa.Column("override_check_in_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "event_rsvps", sa.Column("override_check_out_at", sa.DateTime(), nullable=True)
    )
    op.add_column(
        "event_rsvps",
    ...
    op.add_column(
        "event_rsvps", sa.Column("overridden_by", sa.String(36), nullable=True)
    )
    op.add_column(
        "event_rsvps", sa.Column("overridden_at", sa.DateTime(), nullable=True)
    )

    # Add foreign key constraint for overridden_by
    op.create_foreign_key(
        "fk_event_rsvps_overridden_by",
        "event_rsvps",
        "users",
        ["overridden_by"],
        ["id"],
    ...
    op.create_table(
        ...
        sa.Column(
            "issues_certification", sa.Boolean(), nullable=True, server_default="0"
        ),
        ...
        sa.Column(
            "auto_create_records", sa.Boolean(), nullable=True, server_default="1"
        ),
        sa.Column(
        ...
        sa.Column(
            "approval_deadline_days", sa.Integer(), nullable=True, server_default="7"
        ),
    ...
    op.create_index(
        "idx_training_session_event", "training_sessions", ["event_id"], unique=True
    )
    op.create_index(
        "idx_training_session_org", "training_sessions", ["organization_id"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum(
                "pending", "approved", "modified", "rejected", name="approvalstatus"
            ),
            nullable=True,
    ...
    op.create_index(
        "idx_approval_session", "training_approvals", ["training_session_id"]
    )
    op.create_index("idx_approval_status", "training_approvals", ["status"])
    op.create_index(
        "idx_approval_token", "training_approvals", ["approval_token"], unique=True
    )
    op.create_index(
        "idx_approval_deadline", "training_approvals", ["approval_deadline"]
    )
...
def downgrade() -> None:
    ...
    op.drop_constraint(
        "fk_event_rsvps_overridden_by", "event_rsvps", type_="foreignkey"
    )
