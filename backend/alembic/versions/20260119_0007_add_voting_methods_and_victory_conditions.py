...
def upgrade():
    ...
    op.add_column(
        ...
        sa.Column(
            ...
            sa.String(50),
            nullable=False,
            server_default="most_votes",
        ),
    )
    op.add_column(
        "elections", sa.Column("victory_threshold", sa.Integer, nullable=True)
    )
    op.add_column(
        "elections", sa.Column("victory_percentage", sa.Integer, nullable=True)
    )
