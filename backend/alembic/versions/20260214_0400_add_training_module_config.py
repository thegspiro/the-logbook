...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column(
            "show_training_history", sa.Boolean(), nullable=False, server_default="1"
        ),
        sa.Column(
            "show_training_hours", sa.Boolean(), nullable=False, server_default="1"
        ),
        sa.Column(
        ...
        sa.Column(
            "show_pipeline_progress", sa.Boolean(), nullable=False, server_default="1"
        ),
        sa.Column(
            "show_requirement_details", sa.Boolean(), nullable=False, server_default="1"
        ),
        # Shift completion reports
        sa.Column(
            "show_shift_reports", sa.Boolean(), nullable=False, server_default="1"
        ),
        sa.Column("show_shift_stats", sa.Boolean(), nullable=False, server_default="1"),
        # Officer-written content visibility
        sa.Column(
            "show_officer_narrative", sa.Boolean(), nullable=False, server_default="0"
        ),
        sa.Column(
            "show_performance_rating", sa.Boolean(), nullable=False, server_default="1"
        ),
        sa.Column(
            "show_areas_of_strength", sa.Boolean(), nullable=False, server_default="1"
        ),
        sa.Column(
        ...
        sa.Column(
            "show_skills_observed", sa.Boolean(), nullable=False, server_default="1"
        ),
        # Self-reported submissions
        sa.Column(
            "show_submission_history", sa.Boolean(), nullable=False, server_default="1"
        ),
        # Reports access
        sa.Column(
    ...
    op.create_index(
        "idx_training_config_org", "training_module_configs", ["organization_id"]
    )
