...
def upgrade() -> None:
    op.add_column(
        "form_fields", sa.Column("condition_field_id", sa.String(36), nullable=True)
    )
    op.add_column(
        "form_fields", sa.Column("condition_operator", sa.String(20), nullable=True)
    )
    op.add_column(
        "form_fields", sa.Column("condition_value", sa.String(500), nullable=True)
    )
