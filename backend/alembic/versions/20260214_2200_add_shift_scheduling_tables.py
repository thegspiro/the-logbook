...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "min_staffing", sa.Integer(), nullable=False, server_default=sa.text("1")
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("description", sa.Text(), nullable=True),
        sa.Column(
            "pattern_type", sa.String(20), nullable=False, server_default="weekly"
        ),
        sa.Column(
            "template_id",
            sa.String(36),
    ...
    op.create_table(
        ...
        sa.Column(
            "position", sa.String(20), nullable=False, server_default="firefighter"
        ),
        sa.Column(
            "assignment_status",
            sa.String(20),
