...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_member_leave_org_user",
        "member_leaves_of_absence",
        ["organization_id", "user_id"],
    )
    op.create_index(
        "idx_member_leave_dates", "member_leaves_of_absence", ["start_date", "end_date"]
    )


def downgrade() -> None:
    op.drop_index("idx_member_leave_dates", table_name="member_leaves_of_absence")
    op.drop_index("idx_member_leave_org_user", table_name="member_leaves_of_absence")
