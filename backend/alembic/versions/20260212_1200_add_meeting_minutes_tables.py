...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("draft", "submitted", "approved", "rejected", name="minutesstatus"),
            nullable=False,
            server_default="draft",
        ),
        sa.Column("submitted_at", sa.DateTime(), nullable=True),
        sa.Column(
            "submitted_by", sa.String(36), sa.ForeignKey("users.id"), nullable=True
        ),
        ...
        sa.Column(
            "rejected_by", sa.String(36), sa.ForeignKey("users.id"), nullable=True
        ),
    ...
    op.create_index(
        "ix_meeting_minutes_organization_id", "meeting_minutes", ["organization_id"]
    )
    op.create_index(
        "ix_meeting_minutes_meeting_date", "meeting_minutes", ["meeting_date"]
    )
    op.create_index("ix_meeting_minutes_status", "meeting_minutes", ["status"])
    op.create_index(
        "ix_meeting_minutes_meeting_type", "meeting_minutes", ["meeting_type"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "minutes_id",
            sa.String(36),
            sa.ForeignKey("meeting_minutes.id", ondelete="CASCADE"),
            nullable=False,
        ),
        ...
        sa.Column(
            "status",
            sa.Enum("passed", "failed", "tabled", "withdrawn", name="motionstatus"),
            nullable=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "priority",
            sa.Enum("low", "medium", "high", "urgent", name="actionitempriority"),
            nullable=False,
