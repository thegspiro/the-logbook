...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "default_rate_limit", sa.Integer(), nullable=False, server_default="1000"
        ),
        sa.Column(
            "cache_ttl_seconds", sa.Integer(), nullable=False, server_default="300"
        ),
    ...
    op.create_index(
        op.f("ix_public_portal_config_organization_id"),
        "public_portal_config",
        ["organization_id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["config_id"], ["public_portal_config.id"], ondelete="CASCADE"
        ),
        sa.ForeignKeyConstraint(["created_by"], ["users.id"], ondelete="SET NULL"),
        sa.UniqueConstraint("key_hash"),
    )
    op.create_index(
        op.f("ix_public_portal_api_keys_organization_id"),
        "public_portal_api_keys",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        "idx_api_key_prefix", "public_portal_api_keys", ["key_prefix"], unique=False
    )
    op.create_index(
        "idx_api_key_active", "public_portal_api_keys", ["is_active"], unique=False
    )
    op.create_index(
        op.f("ix_public_portal_api_keys_key_hash"),
        "public_portal_api_keys",
        ["key_hash"],
        unique=True,
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "flagged_suspicious", sa.Boolean(), nullable=False, server_default="0"
        ),
        ...
        sa.ForeignKeyConstraint(
            ["api_key_id"], ["public_portal_api_keys.id"], ondelete="SET NULL"
        ),
    )
    op.create_index(
        op.f("ix_public_portal_access_log_organization_id"),
        "public_portal_access_log",
        ["organization_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_public_portal_access_log_api_key_id"),
        "public_portal_access_log",
        ["api_key_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_public_portal_access_log_ip_address"),
        "public_portal_access_log",
        ["ip_address"],
        unique=False,
    )
    op.create_index(
        op.f("ix_public_portal_access_log_endpoint"),
        "public_portal_access_log",
        ["endpoint"],
        unique=False,
    )
    op.create_index(
        op.f("ix_public_portal_access_log_status_code"),
        "public_portal_access_log",
        ["status_code"],
        unique=False,
    )
    op.create_index(
        "idx_access_log_timestamp",
        "public_portal_access_log",
        ["timestamp"],
        unique=False,
    )
    op.create_index(
        "idx_access_log_suspicious",
        "public_portal_access_log",
        ["flagged_suspicious"],
        unique=False,
    )
    op.create_index(
        "idx_access_log_org_timestamp",
        "public_portal_access_log",
    ...
    op.create_index(
        op.f("ix_public_portal_data_whitelist_organization_id"),
        "public_portal_data_whitelist",
        ["organization_id"],
        unique=False,
    )
    ...
    op.create_index(
        ...
        "public_portal_data_whitelist",
        ["organization_id", "data_category", "field_name"],
        unique=True,
    )
