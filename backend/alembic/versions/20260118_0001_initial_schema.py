...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_user_org_username", "users", ["organization_id", "username"], unique=True
    )
    op.create_index(
        "idx_user_org_email", "users", ["organization_id", "email"], unique=True
    )
    ...
    op.create_index(
        "idx_role_org_slug", "roles", ["organization_id", "slug"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "assigned_at", sa.DateTime(), server_default=sa.text("CURRENT_TIMESTAMP")
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "severity",
            sa.Enum("info", "warning", "critical", name="severitylevel"),
            nullable=False,
        ),
