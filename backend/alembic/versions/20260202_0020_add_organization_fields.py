...
def upgrade() -> None:
    ...
    op.add_column(
        "organizations",
        sa.Column(
            "timezone", sa.String(50), nullable=True, server_default="America/New_York"
        ),
    )
    ...
    op.add_column(
        "organizations", sa.Column("mailing_city", sa.String(100), nullable=True)
    )
    op.add_column(
        "organizations", sa.Column("mailing_state", sa.String(50), nullable=True)
    )
    op.add_column(
        "organizations", sa.Column("mailing_zip", sa.String(20), nullable=True)
    )
    op.add_column(
        "organizations",
        sa.Column(
            "mailing_country", sa.String(100), nullable=True, server_default="USA"
        ),
    )
    ...
    op.add_column(
        "organizations",
        sa.Column(
            "physical_address_same", sa.Boolean(), nullable=True, server_default="1"
        ),
    )
    op.add_column(
        "organizations",
        sa.Column("physical_address_line1", sa.String(255), nullable=True),
    )
    op.add_column(
        "organizations",
        sa.Column("physical_address_line2", sa.String(255), nullable=True),
    )
    op.add_column(
        "organizations", sa.Column("physical_city", sa.String(100), nullable=True)
    )
    op.add_column(
        "organizations", sa.Column("physical_state", sa.String(50), nullable=True)
    )
    op.add_column(
        "organizations", sa.Column("physical_zip", sa.String(20), nullable=True)
    )
    op.add_column(
        "organizations",
        sa.Column(
            "physical_country", sa.String(100), nullable=True, server_default="USA"
        ),
    )
    ...
    op.add_column(
        "organizations", sa.Column("department_id", sa.String(50), nullable=True)
    )

    # Add additional information fields
    op.add_column("organizations", sa.Column("county", sa.String(100), nullable=True))
    op.add_column(
        "organizations", sa.Column("founded_year", sa.Integer(), nullable=True)
    )
