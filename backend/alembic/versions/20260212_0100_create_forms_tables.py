...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "status",
            sa.Enum("draft", "published", "archived", name="formstatus"),
            nullable=False,
    ...
    op.create_index(
        "idx_forms_org_template", "forms", ["organization_id", "is_template"]
    )
    ...
    op.create_index(
        "idx_form_fields_form_order", "form_fields", ["form_id", "sort_order"]
    )
    ...
    op.create_index(
        "idx_form_submissions_org_form",
        "form_submissions",
        ["organization_id", "form_id"],
    )
    op.create_index(
        "idx_form_submissions_org_user",
        "form_submissions",
