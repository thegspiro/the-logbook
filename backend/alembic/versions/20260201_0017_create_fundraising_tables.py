...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "current_amount", sa.Numeric(12, 2), nullable=False, server_default="0.00"
        ),
        ...
        sa.Column(
            "public_page_enabled", sa.Boolean(), nullable=False, server_default="0"
        ),
    ...
    op.create_index(
        "idx_fundraising_campaigns_org", "fundraising_campaigns", ["organization_id"]
    )
    op.create_index(
        "idx_fundraising_campaigns_status",
        "fundraising_campaigns",
        ["organization_id", "status"],
    )
    op.create_index(
        "idx_fundraising_campaigns_type",
        "fundraising_campaigns",
        ["organization_id", "campaign_type"],
    )
    op.create_index(
        "idx_fundraising_campaigns_dates",
        "fundraising_campaigns",
        ["start_date", "end_date"],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "total_donated", sa.Numeric(12, 2), nullable=False, server_default="0.00"
        ),
    ...
    op.create_index(
        "idx_donors_name", "donors", ["organization_id", "last_name", "first_name"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "recurring_frequency",
            sa.Enum(
                "weekly", "monthly", "quarterly", "annually", name="recurringfrequency"
            ),
        ),
        sa.Column("is_anonymous", sa.Boolean(), nullable=False, server_default="0"),
        ...
        sa.Column(
            "dedication_type", sa.Enum("in_honor", "in_memory", name="dedicationtype")
        ),
    ...
    op.create_index(
        "idx_donations_status", "donations", ["organization_id", "payment_status"]
    )
    op.create_index(
        "idx_donations_method", "donations", ["organization_id", "payment_method"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "fulfilled_amount", sa.Numeric(10, 2), nullable=False, server_default="0.00"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "campaign_id",
            sa.String(36),
            sa.ForeignKey("fundraising_campaigns.id", ondelete="CASCADE"),
            nullable=True,
        ),
        sa.Column(
            "event_id",
        ...
        sa.Column(
            "current_attendees", sa.Integer(), nullable=False, server_default="0"
        ),
        sa.Column("revenue_goal", sa.Numeric(12, 2)),
        sa.Column(
            "actual_revenue", sa.Numeric(12, 2), nullable=False, server_default="0.00"
        ),
    ...
    op.create_index(
        "idx_fundraising_events_org", "fundraising_events", ["organization_id"]
    )
    op.create_index(
        "idx_fundraising_events_campaign", "fundraising_events", ["campaign_id"]
    )
    op.create_index("idx_fundraising_events_date", "fundraising_events", ["event_date"])
    op.create_index(
        "idx_fundraising_events_status",
        "fundraising_events",
        ["organization_id", "status"],
    )
