...
def upgrade() -> None:
    ...
    op.add_column(
        "training_module_configs",
        sa.Column("shift_review_default_skills", sa.JSON(), nullable=True),
    )
    op.add_column(
        "training_module_configs",
        sa.Column("shift_review_default_tasks", sa.JSON(), nullable=True),
    )


def downgrade() -> None:
    op.drop_column("training_module_configs", "shift_review_default_tasks")
    op.drop_column("training_module_configs", "shift_review_default_skills")
    op.drop_column("training_module_configs", "shift_review_call_types")
