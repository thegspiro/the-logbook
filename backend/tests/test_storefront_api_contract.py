...
from app.schemas.storefront import (
    ...
    StorefrontPaymentMethodInfo,
    StorefrontResponse,
    StorefrontWindowSummary,
...
_CONTRACT = [
    ...
    (StorefrontWindowSummary, "StorefrontWindowSummary"),
    (StorefrontPaymentMethodInfo, "StorefrontPaymentMethodInfo"),
]
