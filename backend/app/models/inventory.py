...
class InventoryImpactPlan(Base):
    """
    A saved, named impact-planner scenario.

    Persists the planner's filter set so a quartermaster can re-run recurring
    plans (e.g. an annual uniform refresh) without re-entering filters.
    """
