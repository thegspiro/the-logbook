...
class MembershipPipelineService:
    ...
    async def create_prospect(
        ...
        try:
            # Keep a duplicate-key race scoped to this insert. A full session
            # rollback would discard unrelated caller work already flushed in
            # the surrounding transaction (such as a guest check-in).
