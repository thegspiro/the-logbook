...
@router.post(
    "/requirements",
    response_model=TrainingRequirementEnhancedResponse,
...
async def get_training_program(
    ...
    **Authentication required**
    ...
    # Get requirements
    program_requirements = await service.get_program_requirements(
...
async def get_enrollment_progress(
    ...
    **Authentication required**
    ...
    milestones_result = await db.execute(
        ...
        .where(
            ProgramMilestone.completion_percentage_threshold
...
@router.post(
    "/programs/{program_id}/bulk-enroll", response_model=BulkEnrollmentResponse
)
