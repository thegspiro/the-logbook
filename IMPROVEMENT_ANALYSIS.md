...
| 14 | `[Infrastructure]` | **Add database backup automation** | `BACKUP_ENABLED` env var exists but there's no actual backup cron job, script, or documented restore procedure. For an app with HIPAA security features, this is a critical gap. |
